...
model = ParlerTTSForConditionalGeneration.from_pretrained("Atotti/japanese-parler-tts-mini-bate-finetune-jsut-corpus").to(device)
tokenizer = AutoTokenizer.from_pretrained("Atotti/japanese-parler-tts-mini-bate-finetune-jsut-corpus")
